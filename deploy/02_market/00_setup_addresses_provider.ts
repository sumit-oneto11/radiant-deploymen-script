...
const func: DeployFunction = async function (hre: HardhatRuntimeEnvironment) {
  ...
  // NOTE: The script passes 0 as market id to create the same address of LendingPoolAddressesProvider
  ...
  // 2. Set the MarketId
  console.log("=================poolConfig.MarketId===============", poolConfig.MarketId);
  await waitForTx(
...
func.id = `LendingPoolAddressesProvider:${MARKET_NAME}:aave-v3-core@${V3_CORE_VERSION}`;
